...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        new_sentence = Sentence(neighbors - self.mines, count - len(neighbors & self.mines))
        self.knowledge.append(new_sentence)

        # 4) mark any additional cells as safe or as mines if it can be concluded based on the AI's knowledge
        self.update_knowledge()

        # 5) here add any new sentences to the AI's knowledge base if they can be inferred from existing knowledge
        self.infer_new_sentences()

    def update_knowledge(self):
        """
        Update knowledge base by marking additional cells as safe or as mines
        if it can be concluded based on the AI's knowledge base
        """
        while True:
            new_safes = set()
    ...
    def infer_new_sentences(self):
        ...
        self.knowledge.extend(inferred_sentences)
         ...
         # Ensure to mark any additional inferred cells
        self.update_knowledge()
